...
| Producing command | `py -3.12 inference.py --input_dir C:/kla-data/test_NoisyLR --output_dir <out> --require_weights --verbose` |
| Producing checkpoint | EMA weights, release SHA `9c0f39a72542a313aa74c00d6d0b40205b8504b8fcf3d5acfe92ba1149592313` |
| Current tracked checkpoint | SHA `cc67c22f7cfc9926af7425bfa1af448237162d320970be6848129e0a3309d054` |
| Tensor equivalence | Model and EMA tensors are byte-identical; the tracked file adds canonical config and source provenance metadata |
| Producing source | Git `c209cd213f6b4df0f5a6676a1671d5a8828a057c`, clean tree |
...
historical **release-output generation** run on an RTX 4060 Laptop GPU: 20.09 s from the
internal pipeline timer. Linux/CUDA fresh-clone compatibility was checked, but no final
