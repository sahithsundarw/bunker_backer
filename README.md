...
| U-Net baseline (historical 20k RTX 4060 run; not the tracked checkpoint) | 28.8808 ± 4.5328 | 0.78273 ± 0.14245 | 0.26525 ± 0.14878 | 26.69 img/s (historical RTX 4060 external-process run) |
...
Values are `mean ± population standard deviation`. The classical and historical 20k U-Net
records are in `results/metrics_summary.md`; the current tracked checkpoint's disk-verified
400-pair result is recorded in `weights/README.md`, `results/experiments.csv`, and
`docs/decisions.md` D28/D29. These are validation metrics, never final-test metrics.
